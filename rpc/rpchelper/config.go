...
const DefaultFilterTimeout time.Duration = 5 * time.Minute
...
type FiltersConfig struct {
	...
	RpcSubscriptionFiltersTimeout      time.Duration // Timeout before idle filters are evicted. Default: 5 minutes; 0 disables eviction.
}
