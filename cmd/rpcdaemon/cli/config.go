...
func RootCommand() (*cobra.Command, *httpcfg.HttpCfg) {
	...
	rootCmd.PersistentFlags().DurationVar(&cfg.RpcFiltersConfig.RpcSubscriptionFiltersTimeout, "rpc.subscription.filters.timeout", rpchelper.DefaultFiltersConfig.RpcSubscriptionFiltersTimeout, "Timeout before idle filters are evicted. Defaults to 5 minutes. Set to 0 to disable eviction.")
